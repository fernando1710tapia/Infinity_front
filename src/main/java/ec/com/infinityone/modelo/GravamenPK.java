 ...
 * @author HP
 */
public class GravamenPK implements Serializable{
    ...
    public GravamenPK(String codigocomercializadora, String codigo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GravamenPK)) {
            return false;
        }
        GravamenPK other = (GravamenPK) object;
