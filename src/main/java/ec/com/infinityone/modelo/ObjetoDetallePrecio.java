 ...
 * @author HP
 */
public class ObjetoDetallePrecio implements Serializable {
    ...
    public ObjetoDetallePrecio() {
    }
    public ObjetoDetallePrecio(Precio precio, BigDecimal pvpsugerido, BigDecimal precioepp, BigDecimal precioTerminalEpp, BigDecimal iva, BigDecimal margenxcliente, BigDecimal ivaPresuntivo, BigDecimal tresPorMil, BigDecimal precioProducto) {
        this.precio = precio;
