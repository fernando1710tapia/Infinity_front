...
public class Prepedido implements Serializable {
    ...
    protected PrepedidoPK PrepedidoPK;
    ...
    public Prepedido(PrepedidoPK PrepedidoPK) {
        this.PrepedidoPK = PrepedidoPK;
    }

    public Prepedido(PrepedidoPK PrepedidoPK, String fechaventa, String fechadespacho, boolean activa,
    ...
    public Prepedido(String codigoabastecedora, String codigocomercializadora, String numero) {
        this.PrepedidoPK = new PrepedidoPK(codigoabastecedora, codigocomercializadora, numero);
    }

    public PrepedidoPK getPrepedidoPK() {
        return PrepedidoPK;
    }

    public void setPrepedidoPK(PrepedidoPK PrepedidoPK) {
        this.PrepedidoPK = PrepedidoPK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (PrepedidoPK != null ? PrepedidoPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Prepedido)) {
            return false;
        }
        Prepedido other = (Prepedido) object;
        if ((this.PrepedidoPK == null && other.PrepedidoPK != null)
                || (this.PrepedidoPK != null && !this.PrepedidoPK.equals(other.PrepedidoPK))) {
            return false;
        }
        return true;
    }
