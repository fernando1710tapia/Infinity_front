...
public class Detalleprepedido implements Serializable {
    
    protected DetalleprepedidoPK DetalleprepedidoPK;
    ...
    public Detalleprepedido(DetalleprepedidoPK DetalleprepedidoPK) {
        this.DetalleprepedidoPK = DetalleprepedidoPK;
    }

    public Detalleprepedido(DetalleprepedidoPK DetalleprepedidoPK, BigDecimal volumennaturalrequerido, BigDecimal volumennaturalautorizado, String usuarioactual) {
        this.DetalleprepedidoPK = DetalleprepedidoPK;
    ...
    public Detalleprepedido(String codigoabastecedora, String codigocomercializadora, String numero, String codigoproducto, String codigomedida) {
        this.DetalleprepedidoPK = new DetalleprepedidoPK(codigoabastecedora, codigocomercializadora, numero, codigoproducto, codigomedida);
    }

    public DetalleprepedidoPK getDetalleprepedidoPK() {
        return DetalleprepedidoPK;
    }

    public void setDetalleprepedidoPK(DetalleprepedidoPK DetalleprepedidoPK) {
        this.DetalleprepedidoPK = DetalleprepedidoPK;
    }
...
//    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (DetalleprepedidoPK != null ? DetalleprepedidoPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Detalleprepedido)) {
            return false;
        }
        Detalleprepedido other = (Detalleprepedido) object;
        if ((this.DetalleprepedidoPK == null && other.DetalleprepedidoPK != null) || (this.DetalleprepedidoPK != null && !this.DetalleprepedidoPK.equals(other.DetalleprepedidoPK))) {
            return false;
        }
        return true;
    }
