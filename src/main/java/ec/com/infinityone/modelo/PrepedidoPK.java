 ...
 * @author HP
 */
public class PrepedidoPK implements Serializable{
    ...
    public PrepedidoPK(String codigoabastecedora, String codigocomercializadora, String numero) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrepedidoPK)) {
            return false;
        }
        PrepedidoPK other = (PrepedidoPK) object;
