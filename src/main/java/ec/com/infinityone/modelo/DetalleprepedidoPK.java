 ...
 * @author HP
 */
public class DetalleprepedidoPK implements Serializable{
    ...
    public DetalleprepedidoPK() {
    }

    public DetalleprepedidoPK(String codigoabastecedora, String codigocomercializadora, String numero, String codigoproducto, String codigomedida) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DetalleprepedidoPK)) {
            return false;
        }
        DetalleprepedidoPK other = (DetalleprepedidoPK) object;
