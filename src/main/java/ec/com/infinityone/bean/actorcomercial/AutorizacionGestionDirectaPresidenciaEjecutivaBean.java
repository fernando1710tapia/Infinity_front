...
@Named
@ViewScoped
public class AutorizacionGestionDirectaPresidenciaEjecutivaBean extends ReusableBean implements Serializable {
     ...
     */
    public AutorizacionGestionDirectaPresidenciaEjecutivaBean() {
    }
...
// modificar a variable de fiches		EnviarMail.setCorreoErrores("notificaciones@petrolrios.ec"); 
