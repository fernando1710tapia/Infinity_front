...
@Named
@ViewScoped
public class AutorizacionGestionDirectaJefaturaFinancieraBean extends ReusableBean implements Serializable {
	/**
	 * 
	 */
	 ...
	 */
	public AutorizacionGestionDirectaJefaturaFinancieraBean() {
	}
